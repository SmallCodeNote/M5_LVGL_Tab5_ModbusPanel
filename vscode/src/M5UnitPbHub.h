...
public:
    bool begin(TwoWire *wire = &Wire, uint8_t addr = UNIT_PBHUB_I2C_ADDR, uint8_t sda = 21, uint8_t scl = 22,
               long freq = 400000U);
    ...
    bool fillLEDColor(uint8_t ch, uint8_t start, uint8_t count, uint32_t rgb888);
